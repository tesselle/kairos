...
[**tabula**](https://www.tesselle.org/tabula/) is a companion package to **kairos** that provides functions for visualization and analysis of archaeological count data.
...
```{r seriation, fig.width=5, fig.height=5, out.width='50%', fig.show='hold'}
