...
```{r aoristic, echo=FALSE, fig.show='hold', out.width='50%'}
## Aoristic Analysis
...
```{r event, echo=FALSE, fig.show='hold', out.width='50%'}
...
plot(event, type = "activity", select = "LZ1105")
plot(event, type = "tempo", select = "LZ1105")
```
